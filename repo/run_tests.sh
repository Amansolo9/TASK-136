...
# Stop the app service if running — it shares the workspace and its Gradle
...
if [ -d "/opt/android-sdk" ]; then
    ...
    ./gradlew :shared:testDebugUnitTest --no-daemon --project-cache-dir /tmp/gradle-test-cache "$@"
